...
{ //
    ...
    ADC_IRQHandler,                    /* 18 ADC1 and ADC2 */
    ...
    TIM8_BRK_TIM12_IRQHandler,         /* 43 RESERVED: TIM8 Break and TIM12 */
    TIM8_UP_TIM13_IRQHandler,          /* 44 RESERVED: TIM8 Update and TIM13 */
    TIM8_TRG_COM_TIM14_IRQHandler,     /* 45 RESERVED: TIM8 Trigger and Commutation and TIM14 */
    TIM8_CC_IRQHandler,                /* 46 RESERVED: TIM8 Capture Compare */
    DMA1_Stream7_IRQHandler,           /* 47 RESERVED: DMA1 Stream7 */
    FSMC_IRQHandler,                   /* 48 RESERVED: FSMC */
    SDIO_IRQHandler,                   /* 49 RESERVED: SDIO */
    TIM5_IRQHandler,                   /* 50 TIM5 */
    SPI3_IRQHandler,                   /* 51 SPI3 */
    UART4_IRQHandler,                  /* 52 UART4 */
    UART5_IRQHandler,                  /* 53 UART5 */
    TIM6_DAC_IRQHandler,               /* 54 TIM6  */

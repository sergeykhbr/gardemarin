...
void KernelClass::addToOutputList(FwAttribute *attr, uint32_t period) {
    
}

void KernelClass::removeFromOutputList(FwAttribute *attr) {
}
...
void KernelClass::OutputControlAttribute::post_write() {
    FwObject *obj;
    FwAttribute *attr;
    ValueType ctrl;
    ctrl.u32 = u_.u32;
